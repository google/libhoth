...
#define SPI_PROXY_TEST_DATA_LEN_64K (65536 + 512)
#define SPI_PROXY_TEST_ADDR_64K (SPI_PROXY_TEST_DATA_LEN_64K)
...
TEST_F(LibHothTest, spi_proxy_update_64k_erase) {
  ...
  EXPECT_EQ(libhoth_spi_proxy_update(&spi, SPI_PROXY_TEST_ADDR_64K, buffer.data(), SPI_PROXY_TEST_DATA_LEN_64K, nullptr),
            LIBHOTH_OK);
}