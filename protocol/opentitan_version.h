...
static_assert(offsetof(struct opentitan_owner_config_version, config_version) == 0, "");
...
static_assert(offsetof(struct opentitan_get_version_resp, primary_bl0_slot) == 288, "");
static_assert(offsetof(struct opentitan_get_version_resp, bl0_min_sec_ver) == 292, "");
...
int libhoth_ot_version_eq(const struct opentitan_image_version * a,
